...
| Patient identity banner (ABHA, ward/bed, consultant, photo)                                                                            | `CollectionDetails/PatientDetails/PatientDetails.jsx` → `PatientBanner`, `PatientPhotoLightbox`                                                                                    | none — comes from the `Patient` object already loaded                                                                                       |
| Tariff Details / building a bill, live tariff search, discounts                                                                        | `CollectionDetails/BillingDetails/BillingDetails.jsx`                                                                                                                              | `getTariffs(filters)` for the searchable catalogue                                                                                          |
| IPD Advance / Package / Part Payment / Bill Settlement forms                                                                           | `CollectionDetails/BillingDetails/BillingDetails.jsx`                                                                                                                              | none directly — context comes from `checkEligibility`'s `workflowContext`                                                                   |
| Per-line settlement audit popup ("Details" icon)                                                                                       | `CollectionDetails/BillingDetails/BillingDetails.jsx` → `TariffDetailsDialog`                                                                                                      | none — renders `workflowContext.chargeBreakdown` already loaded                                                                             |
