...
| Tariff Details / building a bill, live tariff search, discounts                                                                        | `CollectionDetails/BillingDetails/BillingDetails.jsx`                                                                                                                              | Request `tariff_lines` supply raised lines; bootstrap supplies addable catalogue. API 19 documents the shared tile rules.                   |
